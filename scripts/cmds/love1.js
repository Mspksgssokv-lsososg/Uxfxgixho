...
async function generateLoveImage(uid1, uid2) {
    ...
    const driveImage = await axios.get("https://drive.google.com/uc?export=download&id=11X8zbvhW6-vXsC65-rjdnNjbD2JJdRSr", {
    ...
    background
        .composite(av1.resize(470, 460), 128, 210)
        .composite(av2.resize(470, 460), 800, 200);
